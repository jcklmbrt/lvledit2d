...
struct GLCanvas : public wxGLCanvas
{
	...
	bool IsSnapToGrid() { return Editor.SnapToGrid; }
	Point2D GetMousePos() { return MousePosition; }
	EditorContext &GetEditor() { return Editor; };
	ViewMatrixBase &GetView() { return ViewMatrix; }
